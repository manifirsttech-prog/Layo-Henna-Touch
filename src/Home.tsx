    ...
    <div className="app">
      ...
      <section id="showcase" className="showcase">
        <div className="container">
          ...
          <div className="showcase-grid">
            ...
            <div className="showcase-card">
              <img 
                src={traditionalDesigns[0]?.imageUrl || 'https://via.placeholder.com/400x500/3b82f6/ffffff?text=Traditional+Designs'} 
            ...
            <div className="showcase-card">
              <img 
                src={feetDesigns[0]?.imageUrl || 'https://via.placeholder.com/400x500/3b82f6/ffffff?text=Feet+Designs'} 
      ...
      <section id="book" className="booking-cta">
        <div className="container">
          ...
          <a href="https://wa.me/8085521289" className="cta-button" target="_blank" rel="noopener noreferrer">
            Book Appointment
          </a>
        </div>
      </section>
      ...
      <footer className="footer">
        <div className="container">
          <div className="footer-content">
            ...
            <div className="footer-section">
              ...
              <div className="social-links">
                <a href="https://wa.me/8085521289" target="_blank" rel="noopener noreferrer">
          ...
          <div className="footer-bottom">
            <p>&copy; 2024 Layo Henna Touch. All rights reserved.</p>
          </div>
        </div>
      </footer>
